...
const About = () => {
  return (
    <>
      ...
      >
        As an enterprising engineering student, I am ardently devoted to
        exploring various technological domains. With a profound command over
        TypeScript, I leverage its robustness in combination with Firebase and
